          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6">
              ...
              <p className="text-slate-600 text-base mb-4 leading-relaxed">
                <i>
                  Nilparrot is a close-knit, experienced, passionate team of
                  designers, developers, analysts, researchers, and
                  professionals who enjoy solving challenging tasks and taking
                  appropriate actions on time!
                </i>{" "}
              </p>
              <p className="text-slate-600 text-base mb-8 leading-relaxed">
                We believe in the saying, "You dream it, and we make sure to
                build it." We know how to take custom software development ideas
                from scratch to implementation and delivery. Our professionals
                help clientele with ever-changing new technologies adoption and
                untangle any critical issues that may emerge during the process.
                Our ongoing support is always there to assist clients.
              </p>
